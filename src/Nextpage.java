...
public class Nextpage extends javax.swing.JFrame {
    ...
    public Nextpage(String i) {
        ...
        ps = con1.prepareStatement("SELECT * FROM allt WHERE kw1='"+a+"'");
        ResultSet rs;
        rs = ps.executeQuery();
        if(rs.next()){
            
                    h1=rs.getString(7);
                    jLabel2.setIcon(new javax.swing.ImageIcon(rs.getURL(6)));
                     jLabel3.setText(rs.getString(1));
                     jLabel80.setText(rs.getString(3));
                     jLabel81.setText(rs.getString(2));
        ...
        if(rs.next()){
                     h2=rs.getString(7);
                    jLabel7.setIcon(new javax.swing.ImageIcon(rs.getURL(6)));
                     jLabel8.setText(rs.getString(1));
                     jLabel9.setText(rs.getString(2));
                     jLabel82.setText(rs.getString(3));
        ...
        if(rs.next()){
            h3=rs.getString(7);
                    jLabel12.setIcon(new javax.swing.ImageIcon(rs.getURL(6)));
                     jLabel13.setText(rs.getString(1));
                     jLabel14.setText(rs.getString(3));
                     jLabel83.setText(rs.getString(2));
        ...
        if(rs.next()){
            h4=rs.getString(7);
                    ...
                    jLabel17.setIcon(new javax.swing.ImageIcon(rs.getURL(6)));
                     jLabel18.setText(rs.getString(1));
                     jLabel19.setText(rs.getString(2));
                     jLabel84.setText(rs.getString(3));
        ...
        if(rs.next()){
            h5=rs.getString(7);
                    jLabel22.setIcon(new javax.swing.ImageIcon(rs.getURL(6)));
                     jLabel23.setText(rs.getString(1));
                     jLabel24.setText(rs.getString(2));
                     jLabel85.setText(rs.getString(3));
        ...
        ps1 = con1.prepareStatement("SELECT * FROM allt WHERE kw2 ='"+a+"'");
        ResultSet rs1;
        rs1 = ps1.executeQuery();
        if(rs1.next()){
            
                    t1=rs1.getString(7);
                    jLabel27.setIcon(new javax.swing.ImageIcon(rs1.getURL(6)));
                     jLabel28.setText(rs1.getString(1));
                     jLabel29.setText(rs1.getString(2));
                     jLabel86.setText(rs.getString(3));
        ...
        if(rs1.next()){
                     t2=rs1.getString(7);
                    jLabel32.setIcon(new javax.swing.ImageIcon(rs1.getURL(6)));
                     jLabel33.setText(rs1.getString(1));
                     jLabel34.setText(rs1.getString(2));
                     jLabel87.setText(rs.getString(3));
                     jLabel35.setText(rs1.getString(4));
                     jLabel36.setText(rs1.getString(5));
        ...
        if(rs1.next()){
            t3=rs1.getString(7);
                    jLabel37.setIcon(new javax.swing.ImageIcon(rs1.getURL(6)));
                     jLabel38.setText(rs1.getString(1));
                     jLabel39.setText(rs1.getString(2));
                     jLabel88.setText(rs.getString(3));
                     jLabel40.setText(rs1.getString(4));
                     jLabel41.setText(rs1.getString(5));
      ...
      if(rs.next()){
            t4=rs1.getString(7);
                    ...
                    jLabel42.setIcon(new javax.swing.ImageIcon(rs1.getURL(6)));
                     jLabel43.setText(rs1.getString(1));
                     jLabel44.setText(rs1.getString(2));
                     jLabel89.setText(rs.getString(3));
                     jLabel45.setText(rs1.getString(4));
                     jLabel46.setText(rs1.getString(5));
        ...
        if(rs1.next()){
            t6=rs1.getString(7);
                    jLabel47.setIcon(new javax.swing.ImageIcon(rs1.getURL(6)));
                     jLabel48.setText(rs1.getString(1));
                     jLabel49.setText(rs1.getString(2));
                     jLabel90.setText(rs.getString(3));
                     jLabel50.setText(rs1.getString(4));
                     jLabel51.setText(rs1.getString(5));
                      jButton12.setText("Location");
                  
        }
          
        PreparedStatement ps3;
        ps3 = con1.prepareStatement("SELECT * FROM allt WHERE Name ='"+a+"'");
        ResultSet rs3;
        rs3 = ps3.executeQuery();
        if(rs3.next()){
            
                    p1=rs3.getString(7);
                    jLabel52.setIcon(new javax.swing.ImageIcon(rs3.getURL(6)));
                     jLabel53.setText(rs3.getString(1));
                     jLabel54.setText(rs3.getString(2));
                     jLabel91.setText(rs3.getString(3));
                     jLabel55.setText(rs3.getString(4));
                     jLabel56.setText(rs3.getString(5));
                      jButton13.setText("Location");
                  
        }
        if(rs3.next()){
                     p2=rs3.getString(7);
                    jLabel57.setIcon(new javax.swing.ImageIcon(rs3.getURL(6)));
                     jLabel58.setText(rs3.getString(1));
                     jLabel59.setText(rs3.getString(2));
                     jLabel92.setText(rs3.getString(3));
                     jLabel60.setText(rs3.getString(4));
                     jLabel61.setText(rs3.getString(5));
                   jButton14.setText("Location");
        }
        if(rs3.next()){
            p3=rs3.getString(7);
                    jLabel62.setIcon(new javax.swing.ImageIcon(rs3.getURL(6)));
                     jLabel63.setText(rs3.getString(1));
                     jLabel64.setText(rs3.getString(2));
                     jLabel93.setText(rs3.getString(3));
                     jLabel65.setText(rs3.getString(4));
                     jLabel66.setText(rs3.getString(5));
                   jButton15.setText("Location");
        }
        if(rs3.next()){
            p4=rs3.getString(7);
            
                    jLabel67.setIcon(new javax.swing.ImageIcon(rs3.getURL(6)));
                     jLabel68.setText(rs3.getString(1));
                     jLabel69.setText(rs3.getString(2));
                     jLabel94.setText(rs3.getString(3));
                     jLabel70.setText(rs3.getString(4));
                     jLabel71.setText(rs3.getString(5));
                   jButton16.setText("Location");
        }
        if(rs3.next()){
            p5=rs3.getString(7);
                    jLabel72.setIcon(new javax.swing.ImageIcon(rs3.getURL(6)));
                     jLabel73.setText(rs3.getString(1));
                     jLabel74.setText(rs3.getString(2));
                     jLabel95.setText(rs3.getString(3));
                     jLabel75.setText(rs3.getString(4));
                     jLabel76.setText(rs3.getString(5));
                   jButton17.setText("Location");
        }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel83, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE))
        );
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel82, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jLabel81, javax.swing.GroupLayout.DEFAULT_SIZE, 356, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jLabel85, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap()))
        );
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jLabel89, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel50, javax.swing.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)
                    .addComponent(jButton11))
                .addContainerGap())
        );
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jLabel52, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGap(14, 14, 14)
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel55, javax.swing.GroupLayout.DEFAULT_SIZE, 15, Short.MAX_VALUE)
                    .addComponent(jButton12)))
        );
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel61, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel60, javax.swing.GroupLayout.DEFAULT_SIZE, 15, Short.MAX_VALUE)
                    .addComponent(jButton13))
                .addContainerGap())
        );
        ...
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton15)
                    .addComponent(jLabel70, javax.swing.GroupLayout.DEFAULT_SIZE, 10, Short.MAX_VALUE))
        ...
        jPanel15Layout.setVerticalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel75, javax.swing.GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE)
                    .addComponent(jButton16))
                .addGap(22, 22, 22))
        );
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel17Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanel9, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    ...
                    .addGroup(jPanel17Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanel12, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jPanel13, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanel14, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel17Layout.createSequentialGroup()
                    ...
                    .addContainerGap(3484, Short.MAX_VALUE)))
        );
                            ...
                            .addGroup(jPanel17Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel17Layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
                                        .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jPanel13, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 451, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jPanel12, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 451, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jPanel11, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 445, javax.swing.GroupLayout.PREFERRED_SIZE))))))))
                .addContainerGap(3554, Short.MAX_VALUE))
            .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel17Layout.createSequentialGroup()
                    .addContainerGap()
                    .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(jPanel16, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addContainerGap(4505, Short.MAX_VALUE)))
        );
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        new Nextpage(i).setVisible(true);
        new Nextpage(i).setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.dispose();
...
ABC f = new ABC();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
         ...
         Review r = new Review();
        r.setVisible(true);
       new Review().setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.dispose();
