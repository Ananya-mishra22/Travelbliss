...
public class Review extends javax.swing.JFrame {
    ...
    public Review() {
        ...
        ps = con1.prepareStatement("SELECT * FROM ratings");
...
String a = null ;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          ...
          a = jTextField1.getText().toLowerCase();
        ...
        ps1 = con.prepareStatement("SELECT * FROM ratings WHERE Name='"+a+"'");
        ResultSet rs1;
        rs1 = ps1.executeQuery();
        
       /* String Name = rs1.getString(1);
        String user_name = rs1.getString(2);
        String Ratings = rs1.getString(3);
        String review = rs1.getString(4);
       */ 
