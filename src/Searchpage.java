...
public class Searchpage extends javax.swing.JFrame {
    ...
    public Searchpage(String i) {
      ...
      if(rs.next()){
        ...
        if(rs3.next()){
                    ...
                    h1=rs3.getString(6);
                    jLabel2.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel3.setText(rs3.getString(1));
                     jLabel4.setText(rs3.getString(2));
                     jLabel5.setText(rs3.getString(3));
                     jLabel6.setText(rs3.getString(4));
                    jButton2.setText("Location"); 
                  
        }
        if(rs3.next()){
                     h2=rs3.getString(6);
                    jLabel7.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel8.setText(rs3.getString(1));
                     jLabel9.setText(rs3.getString(2));
                     jLabel10.setText(rs3.getString(3));
                     jLabel11.setText(rs3.getString(4));
                  jButton3.setText("Location");
        }
        if(rs3.next()){
            h3=rs3.getString(6);
                    jLabel12.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel13.setText(rs3.getString(1));
                     jLabel14.setText(rs3.getString(2));
                     jLabel15.setText(rs3.getString(3));
                     jLabel16.setText(rs3.getString(4));
                  jButton4.setText("Location");
        }
        if(rs3.next()){
            h4=rs3.getString(6);
            
                    jLabel17.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel18.setText(rs3.getString(1));
                     jLabel19.setText(rs3.getString(2));
                     jLabel20.setText(rs3.getString(3));
                     jLabel21.setText(rs3.getString(4));
                  jButton5.setText("Location");
        }
        if(rs3.next()){
            h5=rs3.getString(6);
                    jLabel22.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel23.setText(rs3.getString(1));
                     jLabel24.setText(rs3.getString(2));
                     jLabel25.setText(rs3.getString(3));
                     jLabel26.setText(rs3.getString(4));
                  jButton6.setText("Location");
        }
       if(rs3.next()){
            
                    t1=rs3.getString(6);
                    jLabel27.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel28.setText(rs3.getString(1));
                     jLabel29.setText(rs3.getString(2));
                     jLabel30.setText(rs3.getString(3));
        ...
        if(rs3.next()){
                     t2=rs3.getString(6);
                    jLabel32.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel33.setText(rs3.getString(1));
                     jLabel34.setText(rs3.getString(2));
                     jLabel35.setText(rs3.getString(3));
                     jLabel36.setText(rs3.getString(4));
                  jButton8.setText("Location");
        }
        if(rs3.next()){
            t3=rs3.getString(6);
                    jLabel37.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel38.setText(rs3.getString(1));
                     jLabel39.setText(rs3.getString(2));
                     jLabel40.setText(rs3.getString(3));
                     jLabel41.setText(rs3.getString(4));
                  jButton9.setText("Location");
        }
      if(rs3.next()){
            t4=rs3.getString(6);
            
                    jLabel42.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel43.setText(rs3.getString(1));
                     jLabel44.setText(rs3.getString(2));
                     jLabel45.setText(rs3.getString(3));
                     jLabel46.setText(rs3.getString(4));
                  jButton10.setText("Location");
        }
        if(rs3.next()){
            t5=rs3.getString(6);
        ...
        if(rs3.next()){
            t6=rs3.getString(6);
                    jLabel47.setIcon(new javax.swing.ImageIcon(rs3.getURL(5)));
                     jLabel48.setText(rs3.getString(1));
                     jLabel49.setText(rs3.getString(2));
                     jLabel50.setText(rs3.getString(3));
                     jLabel51.setText(rs3.getString(4));
                  jButton11.setText("Location");
        }
    ...
    private void initComponents() {
        ...
        jPanel4.setPreferredSize(new java.awt.Dimension(234, 249));
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel50, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addComponent(jButton11))
                .addContainerGap())
        );
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel55, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addComponent(jButton12))
                .addContainerGap())
        );
        ...
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel71, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addComponent(jLabel69, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel70, javax.swing.GroupLayout.DEFAULT_SIZE, 15, Short.MAX_VALUE)
                    .addComponent(jButton15))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel17Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel17Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(jPanel15, javax.swing.GroupLayout.PREFERRED_SIZE, 284, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jPanel5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 284, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addGroup(jPanel17Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel17Layout.createSequentialGroup()
                            ...
                            .addGap(31, 31, 31)
                            .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jPanel11, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)
